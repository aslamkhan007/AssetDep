...
{
    public class ITDepreciationCalculationController : BaseController
    {
        //
        // GET: /ITDepreciationCalculation/
        public ActionResult ITDepreciationCalculation()
        {
        ...
        #region IT Book Depreciation Calculation
        [HttpPost]
        [ActionName("ITDepreciationCalculation")]
        ...
        public ActionResult FreezeCalculations(ParentViewModel obj)
        {
            ...
            {
                SqlConnection con = DBConnection.getConnection();
                string sql = "Jct_Asset_Dep_Asset_IT_Cal_Freeze_Proc";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.CommandType = CommandType.StoredProcedure;
                //cmd.Parameters.AddWithValue("@BookCode",HttpContext.User.)
                cmd.Parameters.AddWithValue("@BookCode", User.book);
            ...
            return RedirectToAction("ITDepreciationCalculation", "ITDepreciationCalculation", null);
        }
        ...
        public JsonResult GetAccountingYearlist(string Act)
        {
            List<SelectListItem> list = new List<SelectListItem>();
            SqlConnection con = DBConnection.getConnection();
            string sql = "Jct_Asset_Dep_cal_Fin_Year_Fetch";
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
